...
object OptionT {
  ...
  /**
    ...
    */
  private[day4] final class PurePartiallyApplied[F[_]](val dummy: Boolean = true) extends AnyVal {
  ...
  /**
    * Uses the [[http://typelevel.org/cats/guidelines.html#partially-applied-type-params Partially Applied Type Params technique]] for ergonomics.
    */
  private[day4] final class FromOptionPartiallyApplied[F[_]](val dummy: Boolean = true) extends AnyVal {
